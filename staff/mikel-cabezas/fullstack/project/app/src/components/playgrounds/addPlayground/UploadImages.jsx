    ...
    return (<>
        <View className="flex-row relative" >
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="pr-5 ">
                <TouchableOpacity key={1} className="flex flex-col relative items-center justify-center w-[31vw] mr-3 h-36 rounded-2xl bg-mainGray dark:bg-zinc-300  last:mr-12" onPress={!imagesResized[0] ? selectSource : () => deleteImage(imagesResized[0])}>
                ...
                <TouchableOpacity key={2} className="flex flex-col relative items-center justify-center w-[31vw] mr-3 h-36 rounded-2xl bg-mainGray dark:bg-zinc-300  last:mr-12" onPress={!imagesResized[1] ? selectSource : () => deleteImage(imagesResized[1])}>
                ...
                <TouchableOpacity key={3} className="flex flex-col relative items-center justify-center w-[31vw] mr-3 h-36 rounded-2xl bg-mainGray dark:bg-zinc-300  last:mr-12" onPress={!imagesResized[2] ? selectSource : () => deleteImage(imagesResized[2])}>
                ...
                <TouchableOpacity key={4} className="flex flex-col relative items-center justify-center w-[31vw] mr-3 h-36 rounded-2xl bg-mainGray dark:bg-zinc-300  last:mr-12" onPress={!imagesResized[3] ? selectSource : () => deleteImage(imagesResized[3])}>
                ...
                <TouchableOpacity key={5} className="flex flex-col relative items-center justify-center w-[31vw] mr-3 h-36 rounded-2xl bg-mainGray dark:bg-zinc-300  last:mr-12" onPress={!imagesResized[4] ? selectSource : () => deleteImage(imagesResized[4])}>
